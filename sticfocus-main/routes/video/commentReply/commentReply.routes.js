...
router.get("/getComment/:videoId", (req, res) => {
    ...
    commonController
        .getSingleRecordByPopulate(CommentReply, {
            videoId: req.params.videoId
        }, "userId")
        .then((resData) => {
            commonController.count(CommentReply, {
                    videoId: req.params.videoId
                })
                .then((data) => {
...
router.get("/getCommentReply/:videoId", (req, res) => {
    log.debug("/get/video/commentReply")
...
router.get("/get/count/:videoId/reply", (req, res) => {
    log.debug("/get/count/video/comment/reply")
    commonController.count(CommentReply, {
            videoId: req.params.videoId
        })
        .then((resData) => {
